...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Run a design campaign with LASErMPNN and Boltz2x.'
    )
    parser.add_argument('boltz2x_executable_path', type=str,
                        help='Path to the Boltz-2x/1x executable.')
    ...
    parser.add_argument('--ligand-rmsd-mask-atoms', type=str, nargs='+',
                        help='Atoms to IGNORE in RMSD calculation.')
    parser.add_argument('--ligand-burial-mask-atoms', type=str, nargs='+',
                        help='Atoms to IGNORE in burial calculation.')
    ...
    parser.add_argument('--boltz-inference-devices', type=str, nargs='+',
                        ...
                        help='CUDA devices to use for Boltz2x inference'
    ...
    parser.add_argument('--budget-residue-sele-string', type=str, 
                        help="A ProDy selection string of the form "
                        "('resnum 1 or resnum 3 or resnum 5...') to specify "
                        "residues over which to constrain the sampling of "
                        "ALA or GLY residues. This string can be generated "
                        "using `./identify_surface_residues.ipynb`.")
    ...
    params = dict(
        ...
        boltz2x_executable_path = args.boltz2x_executable_path,
        ...
        laser_inference_device = args.laser_inference_device,
